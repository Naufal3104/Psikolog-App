          ...
          <ul class="tc _o sf yo cg ep">
            ...
            <li class="c i" x-data="{ dropdown: false }">
              ...
              <ul class="a" :class="{ 'tc': dropdown }">
                ...
                <li><a href="signup.html" class="xl" :class="{ 'nk': page === 'signup' }">Sign Up</a></li>
        ...
        <div class="tc wf ig pb no">
          <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
            <label class="rc ab i">
              ...
              <!-- Icon Sun -->
              <svg :class="{ 'wn': page === 'home' && !stickyMenu && darkMode, 'xh': page === 'home' && stickyMenu }" class="th om" width="25"
          ...
          <a href="signin.html" :class="{ 'lk' : page === 'home', 'ok' : page === 'home' && stickyMenu }"
            class="ek pk xl">Sign In</a>
          <a href="signup.html" :class="{ 'nk' : page === 'home', 'sh' : page === 'home' && stickyMenu }"
        ...
        <div class="wc qf pn xo ng">
         ...
         <a href="">
           <div class="animate_top sg oi pi zq ml il am cn _m">
            ...
            <h4 class="ek zj kk wm nb _b">Konsultasi</h4>
          </div>
         </a>
