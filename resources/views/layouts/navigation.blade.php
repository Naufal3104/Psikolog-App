        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="inline-flex items-center px-1 pt-1 border-b-2 
                        ...
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center text-sm font-medium leading-5
                                    {{ request()->routeIs('kelola-deteksi.*') || request()->routeIs('kelola-skor.*') || request()->routeIs('kelola-riwayat.*')
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('kelola-deteksi.index')">
