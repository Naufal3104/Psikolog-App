                ...
                <div class="ro">
                    <div
                        ...
                        <ul class="tc uf cg 2xl:ud-gap-15 fb">
                            <li><span class="rc kk wm">Penulis: </span> {{ $artikel->penulis->name }}</li>
                            <li><span class="rc kk wm">Tanggal : </span> {{ $artikel->created_at->format('F d, Y') }}</li>
                        </ul>

                        <p class="justify">{!! nl2br(e($artikel->isi)) !!}</p>
