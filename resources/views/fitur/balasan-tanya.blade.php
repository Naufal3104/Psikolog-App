...
@push('styles')
    ...
    <style>
        .comment-item {
            ...
            gap: 16px;
            padding: 16px 0;
            border-bottom: 1px solid #f3f4f6; /* Garis pemisah antar komentar */
        }
        .comment-item:last-child {
            border-bottom: none; /* Hapus garis di komentar terakhir */
        }
        .avatar-placeholder {
            width: 40px; 
            height: 40px;
            ...
            flex-shrink: 0; 
            color: #6b7280; /* Warna teks ikon/inisial */
            font-weight: 600;
        }
        .comment-content .author-name {
            font-weight: 600;
            color: #1f2937; /* Hitam pekat */
            margin-bottom: 4px;
            display: flex;
            align-items: center;
            gap: 8px;
        ...
        .form-textarea:focus {
            outline: none;
            border-color: #004780; /* Warna biru primer Anda */
        ...
        .submit-button {
            ...
            padding: 10px 24px;
            border-radius: 8px;
            background-color: #004780; /* Warna biru primer Anda */
            color: white;
            font-weight: 600;
        ...
        .submit-button:hover { 
            background-color: #00335c; /* Warna biru lebih gelap */
        }
    </style>
@endpush
        ...
        <div class="bb ze ki xn 2xl:ud-px-0">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="w-full">
                    ...
                    <div class="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10 mb-6">
                        ...
                        <ul class="tc uf cg 2xl:ud-gap-15 fb">
                            ...
                            <li>
                                ...
                                <span style="text-transform: capitalize; font-weight: 600; color: {{ $tanyaJawab->status == 'sudah dijawab' ? '#10a884' : '#f59e0b' }};">
                                    {{ $tanyaJawab->status }}
                                </span>
                            </li>
                        </ul>
                            ...
                            <li>
                                <a href="#!" class="tc wf xf yd ad rg ml il ih wk">
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs><clipPath id="clip0_47_28"><rect width="20" height="20" fill="white" /></clipPath></defs>
                                    </svg>
                                </a>
                            </li>
                            <li>
                                <a href="#!" class="tc wf xf yd ad rg ml il jh wk">
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs><clipPath id="clip0_47_47"><rect width="20" height="20" fill="white" /></clipPath></defs>
                                    </svg>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                        ...
                        <form action="{{-- route('tanya.balas.store', $tanyaJawab->id) --}}#" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="isi_balasan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 sr-only">Balasan Anda:</label>
                                <textarea name="isi_balasan" id="isi_balasan" rows="4" class="form-textarea" placeholder="Tulis balasan Anda di sini..."></textarea>
                            </div>
                            <div>
