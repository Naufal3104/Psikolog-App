<header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll': stickyMenu }" x-data="{ sidebarOpen: false }"
    ...
    <div class="bb ze ri xn 2xl:ud-px-0 oo wf yf i flex items-center justify-between px-4 py-3">
        ...
        <div class="flex lg:hidden items-center ml-auto" style="gap: 16px;">
            ...
            <div class="relative flex-shrink-0">
                <button @click="darkMode = !darkMode" class="flex items-center justify-center w-8 h-8" style="background: transparent; border: none; padding: 0; cursor: pointer;">
            ...
            @auth
                <div x-data="{ profileMobileOpen: false }" @click.away="profileMobileOpen = false" class="relative flex-shrink-0">
                    ...
                    <div x-show="profileMobileOpen" x-transition
                        ...
                        <div class="py-1">
                            <a href="{{ route('user.profile.edit') }}"
                                class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Edit Profil</a>
                            <a href="{{ route('deteksi.riwayat') }}"
                                class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Riwayat Deteksi</a>
                            <form action="{{ route('logout') }}" method="POST" style="margin:0;">
                                @csrf
                                <button type="submit"
